...
**Process**:
Search first, then scrape and evaluate **every** result — not just the first few that look promising. If a page contains related links, follow all of them, not just 1–2. If a discussion mentions new terms or entities, search for each. Perform new searches when needed. Repeat while new data arises.
