...
3. Output contract — `## Summary` (5–15 bullets with inline URLs), `## Full Findings` (detailed notes with sources), `## Execution Log` (numbered steps: action, target, result, reasoning), `## Budget Used` (actual searches/fetches consumed)
